...
SCRIPT = PROJECT_ROOT / "dev-workflow" / "scripts" / "measure_v3_savings.py"
...
def test_negative_delta_reported_not_silenced(tmp_path):
    ...
    fixtures = PROJECT_ROOT / "dev-workflow" / "scripts" / "tests" / "fixtures"
...
def test_missing_fixture_clear_error(tmp_path):
    ...
    import shutil
    v2_arch = PROJECT_ROOT / "dev-workflow/scripts/tests/fixtures/v2-historical/architecture.md"
