...
This file is the v3 content-type-aware writing reference for all dev-workflow skills. It is a Tier 1 hand-edited English file — never apply terse-style compression to it (doing so would break the format-picking guidance it encodes).
...
Machine-readable sidecar: `dev-workflow/memory/format-kit.sections.json` (consumed by `validate_artifact.py` invariants V-02 and V-07).
